...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,020 | 🐛 1,820 | 🌐 Python | 📅 2026-09-08 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,658 | 🐛 638 | 🌐 TypeScript | 📅 2026-09-08 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 332 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-09-08 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,318 | 🐛 552 | 🌐 TypeScript | 📅 2026-09-08 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [DICOM Server](https://github.com/microsoft/dicom-server) ⭐ 513 | 🐛 19 | 🌐 C# | 📅 2026-09-08 - OSS Implementation of DICOMweb standard.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-09-08 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Drishti](https://github.com/nci/drishti/wiki) ⭐ 204 | 🐛 71 | 🌐 C++ | 📅 2026-09-08 - Tomography and electron-microscopy data visualizer for both scientists and lay people.
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-08 - Interoperable web viewer and annotation tool for computational pathology.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,379 | 🐛 148 | 🌐 TSQL | 📅 2026-09-08 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 331 | 🐛 249 | 🌐 Kotlin | 📅 2026-09-08 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
...
* [CyclOps](https://github.com/VectorInstitute/cyclops) ⭐ 95 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Framework for healthcare ML implementation.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,400 | 🐛 1,596 | 🌐 Java | 📅 2026-09-08 - Java API for HL7 FHIR Clients and Servers.
...
* [Metriport](https://github.com/metriport/metriport) ⭐ 776 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
...
* [Datamol](https://github.com/datamol-io/datamol) ⭐ 549 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Molecular Manipulation Made Easy. A light Python wrapper build on top of RDKit.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 361 | 🐛 21 | 🌐 Python | 📅 2026-09-08 - Electronic Health Record analysis in Python.
...
* [FHIRKit Client](https://github.com/Vermonster/fhir-kit-client) ⭐ 186 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-09 - Node FHIR client library.
...
* [Archie](https://github.com/openehr/archie) ⭐ 70 | 🐛 78 | 🌐 Java | 📅 2026-09-04 - OpenEHR Library written in Java.
...
* [Rust FHIR](https://github.com/itsbalamurali/rust-fhir) ⭐ 17 | 🐛 13 | 🌐 Starlark | 📅 2026-09-07 - Rust SDK for HL7 FHIR
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,474 | 🐛 166 | 🌐 Python | 📅 2026-09-08 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Open eHealth Integration Platform](https://github.com/oehf/ipf) ⭐ 193 | 🐛 12 | 🌐 Java | 📅 2026-09-08 - An extension of the Apache Camel routing and mediation engine
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 43 | 🌐 Python | 📅 2026-09-08 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 83 | 🌐 TSQL | 📅 2026-09-08 The unified report library.
...
* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 859 | 🐛 30 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,666 | 🐛 536 | 🌐 Python | 📅 2026-09-08 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,794 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,652 | 🐛 86 | 🌐 Python | 📅 2026-09-03 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 891 | 🐛 181 | 🌐 Groovy | 📅 2026-09-08 - an Open Source Inventory and Supply Chain Management System.
