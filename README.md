...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,488 | 🐛 1,815 | 🌐 Python | 📅 2026-08-25 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,627 | 🐛 640 | 🌐 TypeScript | 📅 2026-08-25 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 328 | 🐛 1,149 | 🌐 TypeScript | 📅 2026-08-25 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,308 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-25 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-08-25 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,390 | 🐛 1,538 | 🌐 Java | 📅 2026-08-25 - Java API for HL7 FHIR Clients and Servers.
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,183 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
...
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 931 | 🐛 63 | 🌐 C# | 📅 2026-08-25 - The official .NET API for HL7 FHIR.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,398 | 🐛 162 | 🌐 Python | 📅 2026-08-25 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,309 | 🐛 225 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 164 | 🐛 44 | 🌐 Python | 📅 2026-08-25 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 82 | 🌐 TSQL | 📅 2026-08-25 The unified report library.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,630 | 🐛 531 | 🌐 Python | 📅 2026-08-25 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,744 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,650 | 🐛 81 | 🌐 Python | 📅 2026-08-20 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 882 | 🐛 186 | 🌐 Groovy | 📅 2026-08-25 - an Open Source Inventory and Supply Chain Management System.
