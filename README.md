...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,914 | 🐛 1,822 | 🌐 Python | 📅 2026-09-05 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,655 | 🐛 633 | 🌐 TypeScript | 📅 2026-09-05 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 332 | 🐛 1,196 | 🌐 TypeScript | 📅 2026-09-05 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,317 | 🐛 550 | 🌐 TypeScript | 📅 2026-09-04 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Dicoogle](https://github.com/bioinformatics-ua/dicoogle) ⭐ 530 | 🐛 61 | 🌐 Java | 📅 2026-07-15 - Dicoogle is an extensible, platform-independent and open-source PACS
* [OpenSlide](https://github.com/openslide/openslide) ⭐ 516 | 🐛 100 | 🌐 C | 📅 2026-09-02 - is a C library for reading whole slide image files.
* [DICOM Server](https://github.com/microsoft/dicom-server) ⭐ 513 | 🐛 19 | 🌐 C# | 📅 2026-09-03 - OSS Implementation of DICOMweb standard.
* [Viv](https://github.com/hms-dbmi/viv) ⭐ 361 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-01 - multiscale visualization of high-resolution multiplexed bioimaging data on the web.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,379 | 🐛 145 | 🌐 TSQL | 📅 2026-09-05 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 331 | 🐛 249 | 🌐 Kotlin | 📅 2026-09-05 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
* [FHIR Works on AWS](https://github.com/awslabs/fhir-works-on-aws-deployment) ⚠️ Archived - FHIR Works on AWS deployment.
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 284 | 🐛 38 | 🌐 C# | 📅 2026-09-05 - Public domain FHIR server developed in C#.
* [Blaze](https://github.com/samply/blaze) ⭐ 227 | 🐛 189 | 🌐 Clojure | 📅 2026-09-05 - A FHIR Store with internal, fast CQL Evaluation Engine
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,399 | 🐛 1,587 | 🌐 Java | 📅 2026-09-05 - Java API for HL7 FHIR Clients and Servers.
...
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,084 | 🐛 135 | 🌐 Go | 📅 2026-06-21 - High Performance DICOM Medical Image Parser in GoLang.
...
* [Metriport](https://github.com/metriport/metriport) ⭐ 776 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
...
* [Hermes](https://github.com/wardle/hermes) ⭐ 237 | 🐛 0 | 🌐 Clojure | 📅 2026-09-01 - a SNOMED CT terminology server.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,451 | 🐛 174 | 🌐 Python | 📅 2026-09-04 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 80 | 🌐 TSQL | 📅 2026-09-05 The unified report library.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,653 | 🐛 537 | 🌐 Python | 📅 2026-09-04 - AI Toolkit for Healthcare Imaging.
...
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,650 | 🐛 82 | 🌐 Python | 📅 2026-09-03 - A Deep Learning Python Toolkit for Healthcare Application.
