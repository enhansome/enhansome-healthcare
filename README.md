...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,432 | 🐛 1,851 | 🌐 Python | 📅 2026-09-21 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,695 | 🐛 672 | 🌐 TypeScript | 📅 2026-09-21 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 335 | 🐛 1,219 | 🌐 TypeScript | 📅 2026-09-21 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,343 | 🐛 555 | 🌐 TypeScript | 📅 2026-09-21 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 275 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,383 | 🐛 161 | 🌐 TSQL | 📅 2026-09-21 - A .NET Core implementation of the FHIR standard.
...
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 284 | 🐛 39 | 🌐 C# | 📅 2026-09-20 - Public domain FHIR server developed in C#.
* [Blaze](https://github.com/samply/blaze) ⭐ 228 | 🐛 193 | 🌐 Clojure | 📅 2026-09-21 - A FHIR Store with internal, fast CQL Evaluation Engine
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,404 | 🐛 1,607 | 🌐 Java | 📅 2026-09-21 - Java API for HL7 FHIR Clients and Servers.
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,196 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
...
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 935 | 🐛 68 | 🌐 C# | 📅 2026-09-16 - The official .NET API for HL7 FHIR.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 361 | 🐛 23 | 🌐 Python | 📅 2026-09-21 - Electronic Health Record analysis in Python.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,543 | 🐛 168 | 🌐 Python | 📅 2026-09-21 - Self-hosted platform to unify wearable health data through one AI-ready API.
* [NextGen Connect Integration Engine](https://github.com/nextgenhealthcare/connect) ⭐ 1,202 | 🐛 411 | 🌐 Java | 📅 2026-09-17 - The swiss army knife of healthcare integration.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,351 | 🐛 241 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 87 | 🌐 TSQL | 📅 2026-09-21 The unified report library.
...
* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 862 | 🐛 31 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,701 | 🐛 518 | 🌐 Python | 📅 2026-09-21 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,827 | 🐛 6 | 🌐 Python | 📅 2026-09-15 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,660 | 🐛 85 | 🌐 Python | 📅 2026-09-21 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 899 | 🐛 180 | 🌐 Groovy | 📅 2026-09-21 - an Open Source Inventory and Supply Chain Management System.
