...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,522 | 🐛 1,844 | 🌐 Python | 📅 2026-09-24 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,702 | 🐛 664 | 🌐 TypeScript | 📅 2026-09-24 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 335 | 🐛 1,211 | 🌐 TypeScript | 📅 2026-09-24 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,345 | 🐛 567 | 🌐 TypeScript | 📅 2026-09-24 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [DICOM Server](https://github.com/microsoft/dicom-server) ⭐ 513 | 🐛 19 | 🌐 C# | 📅 2026-09-23 - OSS Implementation of DICOMweb standard.
* [Viv](https://github.com/hms-dbmi/viv) ⭐ 363 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-23 - multiscale visualization of high-resolution multiplexed bioimaging data on the web.
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 276 | 🐛 1 | 🌐 Python | 📅 2026-09-24 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Omero](https://github.com/ome/openmicroscopy) ⭐ 222 | 🐛 30 | 🌐 Java | 📅 2026-09-22 - open source client/server system written in Java for visualizing, managing, and annotating microscope images and metadata
...
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 167 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-19 - Interoperable web viewer and annotation tool for computational pathology.
...
* [CareKit](https://github.com/carekit-apple/CareKit/) ⭐ 2,528 | 🐛 92 | 🌐 Swift | 📅 2026-04-03 - Open source software framework for creating apps that help people better understand and manage their health.
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,384 | 🐛 158 | 🌐 TSQL | 📅 2026-09-24 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 332 | 🐛 252 | 🌐 Kotlin | 📅 2026-09-18 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
* [FHIR Works on AWS](https://github.com/awslabs/fhir-works-on-aws-deployment) ⚠️ Archived - FHIR Works on AWS deployment.
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 284 | 🐛 38 | 🌐 C# | 📅 2026-09-23 - Public domain FHIR server developed in C#.
* [Blaze](https://github.com/samply/blaze) ⭐ 228 | 🐛 194 | 🌐 Clojure | 📅 2026-09-24 - A FHIR Store with internal, fast CQL Evaluation Engine
...
* [CyclOps](https://github.com/VectorInstitute/cyclops) ⭐ 96 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - Framework for healthcare ML implementation.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,408 | 🐛 1,621 | 🌐 Java | 📅 2026-09-24 - Java API for HL7 FHIR Clients and Servers.
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,198 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,085 | 🐛 135 | 🌐 Go | 📅 2026-06-21 - High Performance DICOM Medical Image Parser in GoLang.
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 957 | 🐛 32 | 🌐 C++ | 📅 2026-09-20 - A Google implementation of protocol buffers for FHIR.
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 935 | 🐛 70 | 🌐 C# | 📅 2026-09-23 - The official .NET API for HL7 FHIR.
* [Metriport](https://github.com/metriport/metriport) ⭐ 784 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
* [Python SMART on FHIR client](https://github.com/smart-on-fhir/client-py) ⭐ 695 | 🐛 28 | 🌐 Python | 📅 2026-09-24 - Flexible Python client for FHIR servers supporting the SMART on FHIR protocol.
* [Android FHIR SDK](https://github.com/google/android-fhir) ⭐ 601 | 🐛 353 | 🌐 Kotlin | 📅 2026-03-25 - The Android FHIR SDK
* [pynetdicom](https://github.com/pydicom/pynetdicom) ⭐ 572 | 🐛 26 | 🌐 Python | 📅 2026-09-07 - A Python implementation of the DICOM networking protocol.
* [Datamol](https://github.com/datamol-io/datamol) ⭐ 551 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Molecular Manipulation Made Easy. A light Python wrapper build on top of RDKit.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 362 | 🐛 21 | 🌐 Python | 📅 2026-09-24 - Electronic Health Record analysis in Python.
...
* [Archie](https://github.com/openehr/archie) ⭐ 70 | 🐛 79 | 🌐 Java | 📅 2026-09-21 - OpenEHR Library written in Java.
...
* [Rust FHIR](https://github.com/itsbalamurali/rust-fhir) ⭐ 17 | 🐛 13 | 🌐 Starlark | 📅 2026-09-24 - Rust SDK for HL7 FHIR
* [nhs-numbers](https://github.com/uk-fci/nhs-number) ⭐ 14 | 🐛 9 | 🌐 Python | 📅 2026-09-16 - Python package to provide utilities for NHS Numbers, including validity checks, normalisation, and generation.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,561 | 🐛 173 | 🌐 Python | 📅 2026-09-24 - Self-hosted platform to unify wearable health data through one AI-ready API.
* [NextGen Connect Integration Engine](https://github.com/nextgenhealthcare/connect) ⭐ 1,204 | 🐛 411 | 🌐 Java | 📅 2026-09-17 - The swiss army knife of healthcare integration.
* [FHIR Converter](https://github.com/microsoft/FHIR-Converter) ⭐ 527 | 🐛 46 | 🌐 Liquid | 📅 2026-09-23 - an open source project that enables conversion of health data from legacy formats to FHIR.
...
* [Open eHealth Integration Platform](https://github.com/oehf/ipf) ⭐ 194 | 🐛 13 | 🌐 Java | 📅 2026-09-24 - An extension of the Apache Camel routing and mediation engine
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,358 | 🐛 245 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 31 | 🌐 Python | 📅 2026-09-22 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 85 | 🌐 TSQL | 📅 2026-09-24 The unified report library.
...
* [Medical Data for Machine Learning](https://github.com/beamandrew/medical-data) ⭐ 6,032 | 🐛 17 | 📅 2023-11-19 - Curated list of medical data for machine learning.

### Design

* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 864 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,705 | 🐛 523 | 🌐 Python | 📅 2026-09-22 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,837 | 🐛 6 | 🌐 Python | 📅 2026-09-15 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,662 | 🐛 88 | 🌐 Python | 📅 2026-09-21 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 900 | 🐛 191 | 🌐 Groovy | 📅 2026-09-24 - an Open Source Inventory and Supply Chain Management System.
