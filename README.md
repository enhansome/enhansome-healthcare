...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,560 | 🐛 1,825 | 🌐 Python | 📅 2026-08-27 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,632 | 🐛 608 | 🌐 TypeScript | 📅 2026-08-27 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 330 | 🐛 1,158 | 🌐 TypeScript | 📅 2026-08-27 - Modular, Production-Ready, Open-Source EHR
...
* [OpenScribe](https://github.com/sammargolis/OpenScribe) ⭐ 204 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-17 - Open source, local-first medical scribe platform for recording clinical encounters, transcribing audio, and generating structured draft clinical notes.
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,310 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-27 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-08-27 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-24 - Interoperable web viewer and annotation tool for computational pathology.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,378 | 🐛 139 | 🌐 TSQL | 📅 2026-08-27 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 328 | 🐛 247 | 🌐 Kotlin | 📅 2026-08-26 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
...
* [Blaze](https://github.com/samply/blaze) ⭐ 227 | 🐛 183 | 🌐 Clojure | 📅 2026-08-27 - A FHIR Store with internal, fast CQL Evaluation Engine
* [Sushi](https://github.com/FHIR/sushi) ⭐ 187 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-18 - a reference implementation command-line interpreter/compiler for FHIR
...
* [CyclOps](https://github.com/VectorInstitute/cyclops) ⭐ 95 | 🐛 8 | 🌐 Python | 📅 2026-08-24 - Framework for healthcare ML implementation.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,390 | 🐛 1,549 | 🌐 Java | 📅 2026-08-26 - Java API for HL7 FHIR Clients and Servers.
* [Fellow Oak DICOM](https://github.com/fo-dicom/fo-dicom) ⭐ 1,210 | 🐛 68 | 🌐 C# | 📅 2026-08-15 - DICOM for .NET, .NET Core, Universal Windows, Android, iOS, Mono, and Unity.
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,184 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,080 | 🐛 135 | 🌐 Go | 📅 2026-06-21 - High Performance DICOM Medical Image Parser in GoLang.
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 949 | 🐛 35 | 🌐 C++ | 📅 2026-08-27 - A Google implementation of protocol buffers for FHIR.
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 931 | 🐛 66 | 🌐 C# | 📅 2026-08-26 - The official .NET API for HL7 FHIR.
* [Metriport](https://github.com/metriport/metriport) ⭐ 768 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-27 - Open-source universal API for healthcare data.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 362 | 🐛 26 | 🌐 Python | 📅 2026-08-24 - Electronic Health Record analysis in Python.
...
* [Hermes](https://github.com/wardle/hermes) ⭐ 235 | 🐛 0 | 🌐 Clojure | 📅 2026-05-10 - a SNOMED CT terminology server.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,408 | 🐛 163 | 🌐 Python | 📅 2026-08-27 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,314 | 🐛 225 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 164 | 🐛 44 | 🌐 Python | 📅 2026-08-26 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 82 | 🌐 TSQL | 📅 2026-08-27 The unified report library.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,636 | 🐛 529 | 🌐 Python | 📅 2026-08-26 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,751 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,650 | 🐛 89 | 🌐 Python | 📅 2026-08-20 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 883 | 🐛 188 | 🌐 Groovy | 📅 2026-08-27 - an Open Source Inventory and Supply Chain Management System.
