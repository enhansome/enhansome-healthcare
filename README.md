...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,182 | 🐛 1,848 | 🌐 Python | 📅 2026-09-13 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,673 | 🐛 639 | 🌐 TypeScript | 📅 2026-09-13 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 333 | 🐛 1,207 | 🌐 TypeScript | 📅 2026-09-13 - Modular, Production-Ready, Open-Source EHR
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-09-13 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,382 | 🐛 154 | 🌐 TSQL | 📅 2026-09-13 - A .NET Core implementation of the FHIR standard.
...
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 284 | 🐛 36 | 🌐 C# | 📅 2026-09-13 - Public domain FHIR server developed in C#.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,402 | 🐛 1,597 | 🌐 Java | 📅 2026-09-13 - Java API for HL7 FHIR Clients and Servers.
...
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 934 | 🐛 69 | 🌐 C# | 📅 2026-09-13 - The official .NET API for HL7 FHIR.
* [Metriport](https://github.com/metriport/metriport) ⭐ 778 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
...
* [Evil-DICOM](https://github.com/rexcardan/Evil-DICOM) ⭐ 191 | 🐛 27 | 🌐 C# | 📅 2024-08-20 - C# DICOM Library.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,497 | 🐛 174 | 🌐 Python | 📅 2026-09-13 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,332 | 🐛 231 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 35 | 🌐 Python | 📅 2026-09-13 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 84 | 🌐 TSQL | 📅 2026-09-13 The unified report library.
...
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,802 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,655 | 🐛 86 | 🌐 Python | 📅 2026-09-12 - A Deep Learning Python Toolkit for Healthcare Application.
