...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,577 | 🐛 1,831 | 🌐 Python | 📅 2026-08-27 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,633 | 🐛 610 | 🌐 TypeScript | 📅 2026-08-28 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 331 | 🐛 1,175 | 🌐 TypeScript | 📅 2026-08-27 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,310 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-27 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [DICOM Server](https://github.com/microsoft/dicom-server) ⭐ 512 | 🐛 18 | 🌐 C# | 📅 2026-08-27 - OSS Implementation of DICOMweb standard.
...
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-27 - Interoperable web viewer and annotation tool for computational pathology.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,378 | 🐛 137 | 🌐 TSQL | 📅 2026-08-27 - A .NET Core implementation of the FHIR standard.
...
* [Blaze](https://github.com/samply/blaze) ⭐ 227 | 🐛 185 | 🌐 Clojure | 📅 2026-08-27 - A FHIR Store with internal, fast CQL Evaluation Engine
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,390 | 🐛 1,562 | 🌐 Java | 📅 2026-08-27 - Java API for HL7 FHIR Clients and Servers.
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,185 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,081 | 🐛 135 | 🌐 Go | 📅 2026-06-21 - High Performance DICOM Medical Image Parser in GoLang.
...
* [Metriport](https://github.com/metriport/metriport) ⭐ 772 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
...
* [Hermes](https://github.com/wardle/hermes) ⭐ 236 | 🐛 0 | 🌐 Clojure | 📅 2026-08-27 - a SNOMED CT terminology server.
...
* [Archie](https://github.com/openehr/archie) ⭐ 67 | 🐛 78 | 🌐 Java | 📅 2026-08-27 - OpenEHR Library written in Java.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,411 | 🐛 167 | 🌐 Python | 📅 2026-08-27 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,318 | 🐛 225 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,753 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 884 | 🐛 189 | 🌐 Groovy | 📅 2026-08-27 - an Open Source Inventory and Supply Chain Management System.
