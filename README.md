...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,971 | 🐛 1,847 | 🌐 Python | 📅 2026-09-07 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,657 | 🐛 638 | 🌐 TypeScript | 📅 2026-09-07 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 332 | 🐛 1,194 | 🌐 TypeScript | 📅 2026-09-07 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,318 | 🐛 553 | 🌐 TypeScript | 📅 2026-09-04 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [DICOM Server](https://github.com/microsoft/dicom-server) ⭐ 513 | 🐛 19 | 🌐 C# | 📅 2026-09-07 - OSS Implementation of DICOMweb standard.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Drishti](https://github.com/nci/drishti/wiki) ⭐ 204 | 🐛 71 | 🌐 C++ | 📅 2026-09-07 - Tomography and electron-microscopy data visualizer for both scientists and lay people.
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-07 - Interoperable web viewer and annotation tool for computational pathology.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,379 | 🐛 148 | 🌐 TSQL | 📅 2026-09-07 - A .NET Core implementation of the FHIR standard.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,400 | 🐛 1,591 | 🌐 Java | 📅 2026-09-07 - Java API for HL7 FHIR Clients and Servers.
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,191 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
...
* [pynetdicom](https://github.com/pydicom/pynetdicom) ⭐ 570 | 🐛 22 | 🌐 Python | 📅 2026-09-07 - A Python implementation of the DICOM networking protocol.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 361 | 🐛 24 | 🌐 Python | 📅 2026-09-07 - Electronic Health Record analysis in Python.
...
* [nhs-numbers](https://github.com/uk-fci/nhs-number) ⭐ 13 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Python package to provide utilities for NHS Numbers, including validity checks, normalisation, and generation.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,467 | 🐛 171 | 🌐 Python | 📅 2026-09-07 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [FHIR Converter](https://github.com/microsoft/FHIR-Converter) ⭐ 526 | 🐛 45 | 🌐 Liquid | 📅 2026-06-03 - an open source project that enables conversion of health data from legacy formats to FHIR.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,324 | 🐛 229 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 49 | 🌐 Python | 📅 2026-09-07 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 83 | 🌐 TSQL | 📅 2026-09-07 The unified report library.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,662 | 🐛 539 | 🌐 Python | 📅 2026-09-07 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,785 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,651 | 🐛 86 | 🌐 Python | 📅 2026-09-03 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 889 | 🐛 187 | 🌐 Groovy | 📅 2026-09-07 - an Open Source Inventory and Supply Chain Management System.
