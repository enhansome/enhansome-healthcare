...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,532 | 🐛 1,823 | 🌐 Python | 📅 2026-08-26 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,627 | 🐛 643 | 🌐 TypeScript | 📅 2026-08-26 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 329 | 🐛 1,154 | 🌐 TypeScript | 📅 2026-08-26 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,309 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-26 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-08-26 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,377 | 🐛 137 | 🌐 TSQL | 📅 2026-08-26 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 328 | 🐛 246 | 🌐 Kotlin | 📅 2026-08-26 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
...
* [Blaze](https://github.com/samply/blaze) ⭐ 227 | 🐛 180 | 🌐 Clojure | 📅 2026-08-26 - A FHIR Store with internal, fast CQL Evaluation Engine
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,183 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,080 | 🐛 135 | 🌐 Go | 📅 2026-06-21 - High Performance DICOM Medical Image Parser in GoLang.
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 949 | 🐛 34 | 🌐 C++ | 📅 2026-08-26 - A Google implementation of protocol buffers for FHIR.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,408 | 🐛 159 | 🌐 Python | 📅 2026-08-26 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,312 | 🐛 225 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,634 | 🐛 529 | 🌐 Python | 📅 2026-08-26 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,748 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,650 | 🐛 86 | 🌐 Python | 📅 2026-08-20 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 882 | 🐛 187 | 🌐 Groovy | 📅 2026-08-26 - an Open Source Inventory and Supply Chain Management System.
