...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,882 | 🐛 1,823 | 🌐 Python | 📅 2026-09-04 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,653 | 🐛 628 | 🌐 TypeScript | 📅 2026-09-04 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 332 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-09-04 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,318 | 🐛 554 | 🌐 TypeScript | 📅 2026-09-04 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [DICOM Server](https://github.com/microsoft/dicom-server) ⭐ 513 | 🐛 18 | 🌐 C# | 📅 2026-09-03 - OSS Implementation of DICOMweb standard.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-09-04 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Drishti](https://github.com/nci/drishti/wiki) ⭐ 204 | 🐛 71 | 🌐 C++ | 📅 2026-09-04 - Tomography and electron-microscopy data visualizer for both scientists and lay people.
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-01 - Interoperable web viewer and annotation tool for computational pathology.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,379 | 🐛 146 | 🌐 TSQL | 📅 2026-09-04 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 331 | 🐛 250 | 🌐 Kotlin | 📅 2026-09-04 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
* [FHIR Works on AWS](https://github.com/awslabs/fhir-works-on-aws-deployment) ⚠️ Archived - FHIR Works on AWS deployment.
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 284 | 🐛 38 | 🌐 C# | 📅 2026-09-04 - Public domain FHIR server developed in C#.
* [Blaze](https://github.com/samply/blaze) ⭐ 227 | 🐛 186 | 🌐 Clojure | 📅 2026-09-04 - A FHIR Store with internal, fast CQL Evaluation Engine
* [Sushi](https://github.com/FHIR/sushi) ⭐ 188 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-03 - a reference implementation command-line interpreter/compiler for FHIR
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,398 | 🐛 1,587 | 🌐 Java | 📅 2026-09-04 - Java API for HL7 FHIR Clients and Servers.
...
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 952 | 🐛 33 | 🌐 C++ | 📅 2026-09-04 - A Google implementation of protocol buffers for FHIR.
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 932 | 🐛 68 | 🌐 C# | 📅 2026-09-03 - The official .NET API for HL7 FHIR.
* [Metriport](https://github.com/metriport/metriport) ⭐ 774 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
...
* [Archie](https://github.com/openehr/archie) ⭐ 69 | 🐛 78 | 🌐 Java | 📅 2026-09-04 - OpenEHR Library written in Java.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,448 | 🐛 173 | 🌐 Python | 📅 2026-09-04 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Open eHealth Integration Platform](https://github.com/oehf/ipf) ⭐ 193 | 🐛 12 | 🌐 Java | 📅 2026-09-04 - An extension of the Apache Camel routing and mediation engine
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 49 | 🌐 Python | 📅 2026-09-04 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 80 | 🌐 TSQL | 📅 2026-09-04 The unified report library.
...
* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 859 | 🐛 29 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,653 | 🐛 532 | 🌐 Python | 📅 2026-09-04 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,778 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,651 | 🐛 82 | 🌐 Python | 📅 2026-09-03 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 888 | 🐛 189 | 🌐 Groovy | 📅 2026-09-04 - an Open Source Inventory and Supply Chain Management System.
