...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,312 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-28 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-28 - Interoperable web viewer and annotation tool for computational pathology.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,391 | 🐛 1,563 | 🌐 Java | 📅 2026-08-29 - Java API for HL7 FHIR Clients and Servers.
...
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 950 | 🐛 35 | 🌐 C++ | 📅 2026-08-27 - A Google implementation of protocol buffers for FHIR.
...
* [Archie](https://github.com/openehr/archie) ⭐ 67 | 🐛 79 | 🌐 Java | 📅 2026-08-28 - OpenEHR Library written in Java.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,418 | 🐛 168 | 🌐 Python | 📅 2026-08-28 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 884 | 🐛 182 | 🌐 Groovy | 📅 2026-08-28 - an Open Source Inventory and Supply Chain Management System.
