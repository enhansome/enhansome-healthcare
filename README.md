...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,287 | 🐛 1,837 | 🌐 Python | 📅 2026-09-16 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,678 | 🐛 647 | 🌐 TypeScript | 📅 2026-09-16 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 334 | 🐛 1,205 | 🌐 TypeScript | 📅 2026-09-16 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,331 | 🐛 559 | 🌐 TypeScript | 📅 2026-09-16 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Dicoogle](https://github.com/bioinformatics-ua/dicoogle) ⭐ 531 | 🐛 60 | 🌐 Java | 📅 2026-07-15 - Dicoogle is an extensible, platform-independent and open-source PACS
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 1 | 🌐 Python | 📅 2026-09-16 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,382 | 🐛 159 | 🌐 TSQL | 📅 2026-09-16 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 330 | 🐛 248 | 🌐 Kotlin | 📅 2026-09-12 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,403 | 🐛 1,603 | 🌐 Java | 📅 2026-09-16 - Java API for HL7 FHIR Clients and Servers.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 361 | 🐛 23 | 🌐 Python | 📅 2026-09-16 - Electronic Health Record analysis in Python.
...
* [Archie](https://github.com/openehr/archie) ⭐ 70 | 🐛 79 | 🌐 Java | 📅 2026-09-16 - OpenEHR Library written in Java.
...
* [nhs-numbers](https://github.com/uk-fci/nhs-number) ⭐ 14 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - Python package to provide utilities for NHS Numbers, including validity checks, normalisation, and generation.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,511 | 🐛 161 | 🌐 Python | 📅 2026-09-16 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Open eHealth Integration Platform](https://github.com/oehf/ipf) ⭐ 194 | 🐛 13 | 🌐 Java | 📅 2026-09-16 - An extension of the Apache Camel routing and mediation engine
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,339 | 🐛 235 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 861 | 🐛 30 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,687 | 🐛 519 | 🌐 Python | 📅 2026-09-16 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,816 | 🐛 6 | 🌐 Python | 📅 2026-09-15 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,658 | 🐛 83 | 🌐 Python | 📅 2026-09-16 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 896 | 🐛 184 | 🌐 Groovy | 📅 2026-09-16 - an Open Source Inventory and Supply Chain Management System.
