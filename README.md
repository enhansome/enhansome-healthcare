...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,465 | 🐛 1,846 | 🌐 Python | 📅 2026-09-22 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,697 | 🐛 675 | 🌐 TypeScript | 📅 2026-09-22 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 335 | 🐛 1,213 | 🌐 TypeScript | 📅 2026-09-22 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,345 | 🐛 556 | 🌐 TypeScript | 📅 2026-09-22 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Viv](https://github.com/hms-dbmi/viv) ⭐ 362 | 🐛 75 | 🌐 JavaScript | 📅 2026-09-10 - multiscale visualization of high-resolution multiplexed bioimaging data on the web.
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 276 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [ResearchKit](https://github.com/ResearchKit/ResearchKit) ⭐ 5,748 | 🐛 150 | 🌐 Objective-C | 📅 2026-07-15 - Software framework that makes it easy to create apps for medical research or for other research projects.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,383 | 🐛 159 | 🌐 TSQL | 📅 2026-09-22 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 331 | 🐛 252 | 🌐 Kotlin | 📅 2026-09-18 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
* [FHIR Works on AWS](https://github.com/awslabs/fhir-works-on-aws-deployment) ⚠️ Archived - FHIR Works on AWS deployment.
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 284 | 🐛 40 | 🌐 C# | 📅 2026-09-22 - Public domain FHIR server developed in C#.
* [Blaze](https://github.com/samply/blaze) ⭐ 228 | 🐛 191 | 🌐 Clojure | 📅 2026-09-22 - A FHIR Store with internal, fast CQL Evaluation Engine
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,407 | 🐛 1,606 | 🌐 Java | 📅 2026-09-22 - Java API for HL7 FHIR Clients and Servers.
...
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,197 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,085 | 🐛 135 | 🌐 Go | 📅 2026-06-21 - High Performance DICOM Medical Image Parser in GoLang.
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 958 | 🐛 32 | 🌐 C++ | 📅 2026-09-20 - A Google implementation of protocol buffers for FHIR.
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 935 | 🐛 68 | 🌐 C# | 📅 2026-09-22 - The official .NET API for HL7 FHIR.
* [Metriport](https://github.com/metriport/metriport) ⭐ 784 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-28 - Open-source universal API for healthcare data.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 362 | 🐛 23 | 🌐 Python | 📅 2026-09-21 - Electronic Health Record analysis in Python.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,548 | 🐛 172 | 🌐 Python | 📅 2026-09-22 - Self-hosted platform to unify wearable health data through one AI-ready API.
* [NextGen Connect Integration Engine](https://github.com/nextgenhealthcare/connect) ⭐ 1,203 | 🐛 411 | 🌐 Java | 📅 2026-09-17 - The swiss army knife of healthcare integration.
...
* [Open eHealth Integration Platform](https://github.com/oehf/ipf) ⭐ 194 | 🐛 13 | 🌐 Java | 📅 2026-09-22 - An extension of the Apache Camel routing and mediation engine
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,355 | 🐛 241 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 87 | 🌐 TSQL | 📅 2026-09-22 The unified report library.
...
* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 864 | 🐛 31 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,703 | 🐛 520 | 🌐 Python | 📅 2026-09-22 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,830 | 🐛 6 | 🌐 Python | 📅 2026-09-15 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,662 | 🐛 87 | 🌐 Python | 📅 2026-09-21 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 899 | 🐛 184 | 🌐 Groovy | 📅 2026-09-22 - an Open Source Inventory and Supply Chain Management System.
