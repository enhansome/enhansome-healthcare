...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 38,724 | 🐛 1,807 | 🌐 Python | 📅 2026-08-31 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,642 | 🐛 626 | 🌐 TypeScript | 📅 2026-08-31 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 331 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-08-31 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,316 | 🐛 551 | 🌐 TypeScript | 📅 2026-08-31 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-08-31 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Drishti](https://github.com/nci/drishti/wiki) ⭐ 204 | 🐛 71 | 🌐 C++ | 📅 2026-08-27 - Tomography and electron-microscopy data visualizer for both scientists and lay people.
* [Slim](https://github.com/ImagingDataCommons/slim) ⭐ 166 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-31 - Interoperable web viewer and annotation tool for computational pathology.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,378 | 🐛 141 | 🌐 TSQL | 📅 2026-08-31 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 330 | 🐛 247 | 🌐 Kotlin | 📅 2026-08-26 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
* [FHIR Works on AWS](https://github.com/awslabs/fhir-works-on-aws-deployment) ⚠️ Archived - FHIR Works on AWS deployment.
* [Spark](https://github.com/FirelyTeam/spark) ⭐ 283 | 🐛 39 | 🌐 C# | 📅 2026-08-30 - Public domain FHIR server developed in C#.
* [Blaze](https://github.com/samply/blaze) ⭐ 227 | 🐛 190 | 🌐 Clojure | 📅 2026-08-31 - A FHIR Store with internal, fast CQL Evaluation Engine
* [Sushi](https://github.com/FHIR/sushi) ⭐ 187 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-29 - a reference implementation command-line interpreter/compiler for FHIR
...
* [CyclOps](https://github.com/VectorInstitute/cyclops) ⭐ 95 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - Framework for healthcare ML implementation.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,391 | 🐛 1,576 | 🌐 Java | 📅 2026-08-31 - Java API for HL7 FHIR Clients and Servers.
* [Fellow Oak DICOM](https://github.com/fo-dicom/fo-dicom) ⭐ 1,210 | 🐛 69 | 🌐 C# | 📅 2026-08-15 - DICOM for .NET, .NET Core, Universal Windows, Android, iOS, Mono, and Unity.
* [TorchXRayVision](https://github.com/mlmed/torchxrayvision) ⭐ 1,187 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-24 - A library for chest X-ray datasets and models. Including pre-trained models.
...
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 932 | 🐛 65 | 🌐 C# | 📅 2026-08-31 - The official .NET API for HL7 FHIR.
...
* [ehrapy](https://github.com/theislab/ehrapy/) ⭐ 361 | 🐛 24 | 🌐 Python | 📅 2026-08-31 - Electronic Health Record analysis in Python.
...
* [Hermes](https://github.com/wardle/hermes) ⭐ 236 | 🐛 0 | 🌐 Clojure | 📅 2026-08-29 - a SNOMED CT terminology server.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,429 | 🐛 171 | 🌐 Python | 📅 2026-08-31 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Open eHealth Integration Platform](https://github.com/oehf/ipf) ⭐ 193 | 🐛 13 | 🌐 Java | 📅 2026-08-31 - An extension of the Apache Camel routing and mediation engine
...
* [ADAM](https://github.com/bigdatagenomics/adam) ⭐ 1,058 | 🐛 43 | 🌐 Scala | 📅 2026-03-17 - Genomics analysis platform.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,321 | 🐛 225 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 46 | 🌐 Python | 📅 2026-08-26 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 84 | 🌐 TSQL | 📅 2026-08-31 The unified report library.
...
* [Health Icons](https://github.com/resolvetosavelives/healthicons) ⭐ 853 | 🐛 29 | 🌐 TypeScript | 📅 2026-07-28 - A collection of open source icons for public health projects.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,645 | 🐛 530 | 🌐 Python | 📅 2026-08-29 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,765 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,651 | 🐛 89 | 🌐 Python | 📅 2026-08-31 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 886 | 🐛 184 | 🌐 Groovy | 📅 2026-08-31 - an Open Source Inventory and Supply Chain Management System.
