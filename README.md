...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,055 | 🐛 1,816 | 🌐 Python | 📅 2026-09-09 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,663 | 🐛 647 | 🌐 TypeScript | 📅 2026-09-09 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 332 | 🐛 1,187 | 🌐 TypeScript | 📅 2026-09-09 - Modular, Production-Ready, Open-Source EHR
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,319 | 🐛 554 | 🌐 TypeScript | 📅 2026-09-09 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-09-09 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [Drishti](https://github.com/nci/drishti/wiki) ⭐ 204 | 🐛 71 | 🌐 C++ | 📅 2026-09-09 - Tomography and electron-microscopy data visualizer for both scientists and lay people.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,380 | 🐛 149 | 🌐 TSQL | 📅 2026-09-09 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 331 | 🐛 246 | 🌐 Kotlin | 📅 2026-09-09 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,400 | 🐛 1,599 | 🌐 Java | 📅 2026-09-09 - Java API for HL7 FHIR Clients and Servers.
* [Fellow Oak DICOM](https://github.com/fo-dicom/fo-dicom) ⭐ 1,211 | 🐛 75 | 🌐 C# | 📅 2026-09-01 - DICOM for .NET, .NET Core, Universal Windows, Android, iOS, Mono, and Unity.
...
* [FHIR .NET API](https://github.com/FirelyTeam/firely-net-sdk) ⭐ 934 | 🐛 68 | 🌐 C# | 📅 2026-09-03 - The official .NET API for HL7 FHIR.
...
* [FHIRKit Client](https://github.com/Vermonster/fhir-kit-client) ⭐ 187 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-09 - Node FHIR client library.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,481 | 🐛 166 | 🌐 Python | 📅 2026-09-09 - Self-hosted platform to unify wearable health data through one AI-ready API.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,327 | 🐛 229 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 41 | 🌐 Python | 📅 2026-09-09 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [Atlas BI Library](https://github.com/atlas-bi/Library) ⭐ 17 | 🐛 83 | 🌐 TSQL | 📅 2026-09-09 The unified report library.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,668 | 🐛 529 | 🌐 Python | 📅 2026-09-09 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,795 | 🐛 6 | 🌐 Python | 📅 2026-06-03 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 891 | 🐛 184 | 🌐 Groovy | 📅 2026-09-09 - an Open Source Inventory and Supply Chain Management System.
