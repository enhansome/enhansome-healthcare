...
* [ERPNext](https://github.com/frappe/erpnext) ⭐ 39,152 | 🐛 1,840 | 🌐 Python | 📅 2026-09-12 - Modules that help manage patients, appointments, consultations, lab tests, and billing.
* [Medplum](https://github.com/medplum/medplum) ⭐ 2,673 | 🐛 639 | 🌐 TypeScript | 📅 2026-09-12 - Developer platform that enables flexible and rapid development of healthcare apps.
* [Ottehr](https://github.com/masslight/ottehr) ⭐ 333 | 🐛 1,204 | 🌐 TypeScript | 📅 2026-09-12 - Modular, Production-Ready, Open-Source EHR
...
* [OpenScribe](https://github.com/sammargolis/OpenScribe) ⭐ 210 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-17 - Open source, local-first medical scribe platform for recording clinical encounters, transcribing audio, and generating structured draft clinical notes.
...
* [OHIF](https://github.com/OHIF/Viewers) ⭐ 4,323 | 🐛 556 | 🌐 TypeScript | 📅 2026-09-12 - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker.
...
* [Kaapana](https://github.com/kaapana/kaapana) ⭐ 274 | 🐛 7 | 🌐 Python | 📅 2026-09-12 - Open source toolkit for state of the art platform provisioning in the field of medical data analysis.
...
* [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) ⭐ 1,382 | 🐛 154 | 🌐 TSQL | 📅 2026-09-11 - A .NET Core implementation of the FHIR standard.
...
* [Clinical Quality Language](https://github.com/cqframework/clinical_quality_language) ⭐ 330 | 🐛 246 | 🌐 Kotlin | 📅 2026-09-12 - Clinical Quality Language is a HL7 standard for the expression of clinical knowledge.
...
* [HAPI FHIR](https://github.com/hapifhir/hapi-fhir) ⭐ 2,402 | 🐛 1,599 | 🌐 Java | 📅 2026-09-11 - Java API for HL7 FHIR Clients and Servers.
...
* [FHIR protocol buffers](https://github.com/google/fhir) ⭐ 955 | 🐛 33 | 🌐 C++ | 📅 2026-09-04 - A Google implementation of protocol buffers for FHIR.
...
* [nhs-numbers](https://github.com/uk-fci/nhs-number) ⭐ 14 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Python package to provide utilities for NHS Numbers, including validity checks, normalisation, and generation.
...
* [OpenWearables](https://github.com/the-momentum/open-wearables) ⭐ 2,491 | 🐛 174 | 🌐 Python | 📅 2026-09-11 - Self-hosted platform to unify wearable health data through one AI-ready API.
* [NextGen Connect Integration Engine](https://github.com/nextgenhealthcare/connect) ⭐ 1,199 | 🐛 411 | 🌐 Java | 📅 2024-09-23 - The swiss army knife of healthcare integration.
...
* [Synthea Patient Generator](https://github.com/synthetichealth/synthea) ⭐ 3,331 | 🐛 230 | 🌐 Java | 📅 2026-08-18 - Synthetic patient generator that models the medical history of synthetic patients.
...
* [EDS\_NLP](https://github.com/aphp/edsnlp) ⭐ 165 | 🐛 35 | 🌐 Python | 📅 2026-09-12 - provides a set of spaCy components to extract information from clinical notes written in French
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,679 | 🐛 527 | 🌐 Python | 📅 2026-09-12 - AI Toolkit for Healthcare Imaging.
* [MedicalGPT](https://github.com/shibing624/MedicalGPT/blob/main/README_EN.md) ⭐ 5,799 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Training Your Own Medical GPT Model with ChatGPT Training Pipeline.
* [PyHealth](https://github.com/sunlabuiuc/PyHealth) ⭐ 1,655 | 🐛 89 | 🌐 Python | 📅 2026-09-03 - A Deep Learning Python Toolkit for Healthcare Application.
...
* [OpenBoxes](https://github.com/openboxes/openboxes) ⭐ 893 | 🐛 182 | 🌐 Groovy | 📅 2026-09-11 - an Open Source Inventory and Supply Chain Management System.
